...
from .routes import chat, knowledge, catalog, graph, feishu, review, config, reflection, analysis, search, discovery, import_, md_knowledge
...
app.include_router(md_knowledge.router)
